...
export class GithubController {
    ...
    public static async connectGithub(req: AuthRequest, res: Response): Promise<void> {
        try {
    ...
    public static async getUserRepos(req: AuthRequest, res: Response): Promise<void> {
        try {
    ...
    public static async getDirectoryFiles(req: AuthRequest, res: Response): Promise<void> {
        try {
    ...
    public static async importFile(req: AuthRequest, res: Response): Promise<void> {
        try {
