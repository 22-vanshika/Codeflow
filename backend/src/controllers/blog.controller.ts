...
export class BlogController {
    ...
    public static async searchBlogs(req: Request, res: Response): Promise<void> {
        try {
    ...
    public static async toggleBookmark(req: AuthRequest, res: Response): Promise<void> {
        try {
    ...
    public static async toggleBookmarkById(req: AuthRequest, res: Response): Promise<void> {
        try {
            const { id } = req.params;
            const firebaseUid = req.firebaseUid;
