        ...
        <div className="absolute inset-x-0 bottom-0 z-40 pointer-events-none">
            <AnimatePresence>
                {isOpen && (
                    <motion.div 
                        ...
                        className="pointer-events-auto h-[320px] bg-surface/95 backdrop-blur-xl border-t border-border-subtle shadow-[0_-10px_40px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden"
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between px-6 py-3 border-b border-border-subtle bg-surface/30 shrink-0">
                            <div className="flex items-center gap-3">
                                <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-primary/20 text-primary">
                                    <Terminal size={16} />
                                </div>
                                <div>
                                    <h3 className="text-xs font-black text-text-primary uppercase tracking-widest">Console Output</h3>
                        ...
                        <div className="flex-1 flex overflow-hidden">
                            ...
                            <div className="w-1/3 border-r border-border-subtle flex flex-col">
                                <div className="px-4 py-2 border-b border-border-subtle bg-surface/30 flex items-center justify-between">
            ...
            {!isOpen && (
                ...
                >
                    <button 
                        onClick={onToggle}
                        className="flex items-center gap-3 px-6 py-2.5 rounded-2xl bg-surface backdrop-blur-md border border-border-subtle text-text-primary shadow-2xl hover:bg-surface hover:border-primary/50 transition-all group"
                    >
